...
{
	struct i40e_rx_buffer *rx_bi = rx_ring->rx_bi;
...
skip_free:
	memset(rx_ring->rx_bi, 0, rx_ring->bi_size);
...
{
	rx_ring->bi_size = sizeof(struct i40e_rx_buffer) * rx_ring->count;
