...
{
	rx_ring->bi_size = sizeof(struct xdp_buff *) * rx_ring->count;
...
{
	struct xdp_buff **r = (struct xdp_buff **)rx_ring->rx_bi;
...
static int i40e_xsk_umem_disable(struct i40e_vsi *vsi, u16 qid)
{
	...
	xsk_buff_dma_unmap(umem, &vsi->back->pdev->dev, I40E_RX_DMA_ATTR);
